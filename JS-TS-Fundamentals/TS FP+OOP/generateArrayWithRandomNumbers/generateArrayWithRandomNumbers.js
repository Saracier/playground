...
function generateArrayWithRandomNumbers(howManyNumbers, minNumbersAcceptedInArray, maxNumbersAcceptedInArray) {
    if (typeof howManyNumbers !== 'number' ||
    ...
    while (finalArray.length < howManyNumbers) {
        var randomGeneratedNumber = Math.floor(Math.random() * (maxNumbersAcceptedInArray - minNumbersAcceptedInArray)) + minNumbersAcceptedInArray;
        finalArray.push(randomGeneratedNumber);
    }
    return finalArray;
}
function generateArrayOfArrays(howManyArrays, howManyNumbers, minNumbersAcceptedInArray, maxNumbersAcceptedInArray) {
    if (typeof howManyArrays !== 'number' ||
    ...
    for (var i = 0; i < howManyArrays; i++) {
        var generatedArrayOnILoop = generateArrayWithRandomNumbers(howManyNumbers, minNumbersAcceptedInArray, maxNumbersAcceptedInArray);
